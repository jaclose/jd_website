...
export default function Footer() {
  return (
    <footer className="border-t border-slate-200/10 bg-slate-950 text-slate-400">
      <div className="mx-auto max-w-5xl px-6 py-12">
        <div className="flex flex-col items-center gap-6 sm:flex-row sm:justify-between">
          <div>
            <p className="text-sm font-medium text-white">Jafar Dabbagh</p>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-x-6 gap-y-2 text-xs text-slate-500">
          {["Home", "About", "Portfolio", "Blog", "Contact"].map((page) => (
            <Link
              key={page}
